...
本仓库为 monorepo，插件在子目录 `laffey_stickers/`。

```bash
git clone https://github.com/Ayanamy000/astrbot-plugin-laffey.git
sudo cp -a astrbot-plugin-laffey/laffey_stickers /opt/astrbot/data/plugins/
# 或容器内：cp -a astrbot-plugin-laffey/laffey_stickers /AstrBot/data/plugins/
...
- P2：见同仓库 `laffey_affection/`（指挥官 UID、好感档位与口吻注入）  
